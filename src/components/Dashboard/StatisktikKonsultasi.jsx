...
function StatisktikKonsultasi() {
  ...
  return (
    <div className="bg-white p-6 rounded shadow shadow-gray-300 w-[65%] grid grid-cols-2 gap-4">
      <DataDashboard title={"Rata-rata rating"} logo={<IoStarSharp />} data={DataDashboardInfo.averageRating || 0} explanation={`Rata-rata rating konsultasi anda yang telah anda lakukan adalah ${DataDashboardInfo.averageRating} bintang`}/>

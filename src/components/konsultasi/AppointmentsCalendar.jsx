...
function renderEventContent(eventInfo) {
  return (
    <div className="flex h-full cursor-pointer flex-col items-start rounded p-2 text-black" style={{ backgroundColor: eventInfo.event.backgroundColor }}>
      <div className="w-max">

  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 px-5" onClick={handleOverlayClick}>
      <div className="relative w-full max-w-2xl rounded-lg bg-white p-4 shadow-lg" onClick={handleModalContentClick}>
        <div className="flex items-center justify-between">
          <div className="">
            <p className="text-sm text-gray-500">
              Bookings ID <span className="text-base font-medium text-black">{dataModal[0].id}</span>
            </p>
          </div>
        ...
        <div className="mt-2 flex items-center justify-between rounded border-2 border-gray-300 p-2">
          <section className="flex items-center gap-4">
            <img src={`https://ui-avatars.comhttp://api-temanternak.test.h14.my.id/?name=${dataModal[0].bookerName}&background=0D8ABC&color=fff`} alt="" className="aspect-square h-10 rounded-full bg-blue-600" />
            <div className="">
          ...
          <section className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-1 rounded border-2 border-gray-300 px-2 py-1">

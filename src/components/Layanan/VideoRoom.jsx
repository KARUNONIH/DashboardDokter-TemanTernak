                        ...
                        <div className={`max-w-[80%] rounded-lg p-3 ${msg.userId === myData?.id ? "bg-gray-50 text-black" : "bg-blue-600 text-white"}`}>
                          {msg.message.startsWith("WITHFILE:") ? (
                            <div>
                              ...
                              <a href={`/api/${msg.message.split("END;")[0].replace("WITHFILE:", "")}`} target="_blank" rel="noopener noreferrer" className={`${msg.userId === myData?.id ? "text-blue-600" : "text-white"} text-sm underline hover:text-blue-700`}>
                                View Attachment
                              </a>
                            </div>
                          ) : (

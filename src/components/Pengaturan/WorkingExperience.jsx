...
const WorkingExperience = () => {
  ...
  const { data: putData, loading: putLoading, error: putError, fetchData: fetchPut } = PutAuthorization(endpoint, { workingExperiences: data }, token);
  ...
  const handleSave = async () => {
    ...
    if (response) {
      Swal.fire({
        title: "Success!",
        text: "Working experiences updated successfully.",
        icon: "success",
  ...
  return (
    <div className="rounded p-6 shadow shadow-gray-300">
      <h1 className="mb-4 text-lg font-semibold capitalize">Pengalaman Kerja</h1>

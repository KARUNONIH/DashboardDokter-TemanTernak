...
const WorkingExperience = () => {
  ...
  useEffect(() => {
    if (!statusRegistration && dataRegistration.workingExperiences) {
      setWorkingExperiences(dataRegistration.workingExperiences);
    }
  }, [dataRegistration.workingExperiences, statusRegistration]);

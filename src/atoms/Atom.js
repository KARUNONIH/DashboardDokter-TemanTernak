...
export const activeFormRegistrationAtom = atom("progress0");
export const sessionSignAtom = atom(false);
export const navbarCollapseAtom = atom(false);
export const formSpecializationAtom = atom("educations");
...
export const preSignupAtom = atom({ name: "", email: "", password: "", invitationId: "672c453aa5f2b31aa20ca552" }); 
